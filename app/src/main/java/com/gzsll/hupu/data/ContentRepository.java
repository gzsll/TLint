 ...
 */
@Singleton public class ContentRepository implements ContentDataSource {
  ...
  @Inject public ContentRepository(ContentRemoteDataSource mContentRemoteDataSource,
  ...
  @Override public Observable<ThreadInfo> getThreadInfo(String fid, String tid) {
    ...
    return Observable.concat(remoteWithLocalUpdate, local).first(new Func1<ThreadInfo, Boolean>() {
      @Override public Boolean call(ThreadInfo threadInfo) {
