...
public class ImageCacheDao extends AbstractDao<ImageCache, Long> {
  ...
  /** @inheritdoc */
  @Override protected void bindValues(SQLiteStatement stmt, ImageCache entity) {
    stmt.clearBindings();
  ...
  /** @inheritdoc */
  @Override public ImageCache readEntity(Cursor cursor, int offset) {
  ...
  /** @inheritdoc */
  @Override public void readEntity(Cursor cursor, ImageCache entity, int offset) {
  ...
  /** @inheritdoc */
  @Override protected Long updateKeyAfterInsert(ImageCache entity, long rowId) {
    entity.setId(rowId);
    return rowId;
  }

  /** @inheritdoc */
  @Override public Long getKey(ImageCache entity) {
    if (entity != null) {
      return entity.getId();
    } else {
      return null;
