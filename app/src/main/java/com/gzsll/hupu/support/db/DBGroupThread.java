...
public class DBGroupThread {
    ...
    public DBGroupThread(Long id, Integer lights, String username, Long createAtUnixTime, String title, String note, Integer replies, Integer tid, Long serverId, Long userId, Long coverId, Long groupId) {
        this.id = id;
        this.lights = lights;
