...
public interface ForumService {
    ...
    @FormUrlEncoded
    Observable<AttendStatusData> addAttention(@Query("sign") String sign, @FieldMap Map<String, String> params);

    @POST("forums/attentionForumRemove")
    @FormUrlEncoded
    Observable<AttendStatusData> delAttention(@Query("sign") String sign, @FieldMap Map<String, String> params);
    ...
    @FormUrlEncoded
    Observable<BaseData> addThread(@FieldMap Map<String, String> params);

    @POST("threads/threadReply")
    @FormUrlEncoded
    Observable<BaseData> addReplyByApp(@FieldMap Map<String, String> params);
