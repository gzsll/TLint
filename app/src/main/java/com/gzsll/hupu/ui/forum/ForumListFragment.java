...
public class ForumListFragment extends BaseFragment
  ...
  @Inject ForumListPresenter mPresenter;
  @Inject ForumListAdapter mAdapter;
  ...
  @Override public void renderForumList(List<Forum> forumList) {
    mAdapter.bind(forumList);
  }

  @Override public void showThreadUi(String fid) {
    ThreadListActivity.startActivity(getActivity(), fid);
  }

  @Override public void removeForum(Forum forum) {
  ...
  @Override public void onForumDelAttentionClick(Forum forum) {
