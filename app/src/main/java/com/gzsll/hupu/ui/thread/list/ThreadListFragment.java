...
public class ThreadListFragment extends BaseFragment
  ...
  @Override public void renderThreadInfo(Forum forum) {
  ...
  @Override public void attendStatus(boolean isAttention) {
    if (!isAttention) {
  ...
  @Override public void onFloatingVisibility(int visibility) {
    floatingMenu.setVisibility(visibility);
  }

  @Override public void showPostThreadUi(String fid) {
  ...
  @OnClick(R.id.floatingAttention) void floatingAttention() {
    mPresenter.onAttentionClick();
    floatingMenu.toggle(true);
  }

  @OnClick(R.id.floatingPost) void floatingPost() {
    mPresenter.onPostClick();
    floatingMenu.toggle(true);
  }

  @OnClick(R.id.floatingRefresh) void floatingRefresh() {
    mPresenter.onRefresh();
    floatingMenu.toggle(true);
  }

  @OnClick(R.id.floatingSwitch) void floatingSwitch() {
