 ...
 */
@PerActivity public class ReportPresenter implements ReportContract.Presenter {

  private ForumApi mForumApi;

  @Inject public ReportPresenter(ForumApi forumApi) {
    mForumApi = forumApi;
  }
  ...
  @Override public void attachView(@NonNull ReportContract.View view) {
    mReportView = view;
  }
