 ...
 */
@PerActivity public class GalleryPresenter implements GalleryContract.Presenter {
  ...
  @Inject public GalleryPresenter(Context context) {
    mContext = context;
  }

  @Override public void attachView(@NonNull GalleryContract.View view) {
    mGalleryView = view;
  }
  ...
  @Override public void onImageAndFolderReceive() {
    mSubscription = Observable.create(new Observable.OnSubscribe<Cursor>() {
      ...
      @Override public List<Image> call(Cursor cursor) {
      ...
      @Override public void call(List<Image> images) {
