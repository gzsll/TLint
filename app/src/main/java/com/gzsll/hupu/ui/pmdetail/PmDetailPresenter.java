 ...
 */
@PerActivity public class PmDetailPresenter implements PmDetailContract.Presenter {
  ...
  @Inject public PmDetailPresenter(String uid, GameApi gameApi, UserStorage userStorage) {
    this.uid = uid;
    mGameApi = gameApi;
    mUserStorage = userStorage;
  }

  @Override public void attachView(@NonNull PmDetailContract.View view) {
    mPmDetailView = view;
    mGameApi.queryPmSetting(uid)
        .subscribeOn(Schedulers.io())
        .observeOn(AndroidSchedulers.mainThread())
        .subscribe(new Action1<PmSettingData>() {
          @Override public void call(PmSettingData pmSettingData) {
  ...
  @Override public void onPmDetailReceive() {
  ...
  private void loadPmDetail() {
    mSubscription = mGameApi.queryPmDetail(lastMid, uid)
        ...
        .subscribe(new Action1<PmDetailData>() {
          @Override public void call(PmDetailData pmDetailData) {
  ...
  @Override public void send(String content) {
    ...
    mGameApi.pm(content, uid)
        ...
        .subscribe(new Action1<SendPmData>() {
          @Override public void call(SendPmData sendPmData) {
            if (sendPmData != null) {
