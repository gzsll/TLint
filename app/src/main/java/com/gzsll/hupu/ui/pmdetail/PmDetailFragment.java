...
public class PmDetailFragment extends BaseFragment
  ...
  @Override public void isBlock(boolean isBlock) {
    if (blockItem != null) {
      blockItem.setTitle(isBlock ? "取消屏蔽" : "屏蔽该用户");
    }
  }

  @Override public void renderPmDetailList(List<PmDetail> pmDetails) {
  ...
  @Override public void cleanEditText() {
    etContent.setText("");
  }
  ...
  @OnClick(R.id.btSend) void btSendClick() {
